...
DROP TABLE IF EXISTS numeroawb;
...
-- Create numeroawb table (for your specific OR EXISTS use case)
CREATE TABLE numeroawb (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    ...
    activo BOOLEAN DEFAULT TRUE,
    created_date TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (guia_id) REFERENCES guias_despacho(id),
